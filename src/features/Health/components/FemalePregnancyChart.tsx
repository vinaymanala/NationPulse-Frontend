...
function FemaleHealthByCountryChart({ data }: HealthChartDataByCountryProps) {
      ...
      <ResponsiveContainer width="100%" height={500}>
        ...
        >
          ...
          <Line
            ...
            stroke="#c0603d"
            activeDot={{ r: 8 }}
            name={`${filteredData[0]?.cause} per year`}
          />
...
export default FemaleHealthByCountryChart;
